...
namespace CardGame2022
{
    ...
    internal class GameRubber
    {
        ...
        internal int playerForSelection;
        ...
        /// <summary>
        /// affect the cards for the player
        /// </summary>
        /// <param name="cardsSelectedByPlayers"> the selected cards </param>
        private void PerformAffectAllCards(Dictionary<int, int> cardsSelectedByPlayers)
        {
            ...
            else
            {
                ...
                gameController.DisplayTheRowChose();
            }
        }

        /// <summary>
        /// Give state of the rubber
        /// </summary>
        ...
        /// <summary>
        /// affect a card for a player
        /// </summary>
        /// <param name="cardsSelectedByPlayers">the selected cards </param>
        /// <param name="i">the card index</param>
        /// <returns></returns>
